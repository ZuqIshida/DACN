...
uint8_t readDHT11(dht11_t *dht)
{
	...
	uint8_t humVal = 0, tempVal = 0, humdcimal = 0, tempdcimal = 0, parityVal = 0, genParity = 0;
	uint8_t mData[40];
...
//	HAL_GPIO_WritePin(LD2_GPIO_Port, LD2_Pin, GPIO_PIN_SET);
	...
	genParity = humVal + tempVal + tempdcimal + humdcimal ;
